...
public class LoginServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		System.out.println("in config from init "+config);    
		try {
		openConnection(config.getInitParameter("db_url"),config.getInitParameter("userName"),config.getInitParameter("pwd"));
